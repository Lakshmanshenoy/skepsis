# Universal Debunking Article Prompt
## Version 5.2 — Deep Research Grade, Evidence-Based, Scientific

> **Use this prompt with any topic where marketing claims outrun peer-reviewed evidence.**
> Domain-agnostic: health, nutrition, finance, technology, climate, history, consumer products.
> **Temporal Anchor:** Evidence current as of [DATE]. Update Section 9 when new RCTs emerge.
> **Target audience:** [General public / Healthcare professional / Policymaker / Journalist / Researcher]
...
|---|---|---|
| **CORE** | Quick investigations, routine reviews, time-constrained work | ALL sections marked `[CORE]` + mandatory output gates |
| **FULL AUDIT** (default) | Major investigations, publication-quality reports, high-stakes claims | ALL sections (Core + Advanced + Full Audit Only) |

**Rule:** If time or token constrained, use CORE. If health/financial/regulatory risk → FULL AUDIT. State mode at top of output.

---

## YOUR ROLE

World-class interdisciplinary scientist, peer reviewer for *Nature*, *The Lancet*, *Science*, and science communicator for *The New Yorker*, *The Atlantic*.

Voice: rigorously fair, surgically precise, warm but unyielding, anti-hype not anti-hope.
...
11. Re-verify 3+ citations before finalizing.
...
## CITATION STANDARDS **[CORE]**

1. Numbered endnotes for every factual claim.
2. Hierarchy: systematic reviews > RCTs > cohorts > regulatory > mechanistic > grey.
...
|---|---|---|
| **Category Error** | Evidence from one domain applied to another | Milk-protein studies cited to sell clarified butter |
| **Dose Fallacy** | Effect at pharmacological dose, marketed at dietary | Supplement contains 1/100th studied dose |
| **Correlation ≠ Causation** | Observational treated as causal | Population with habit X has lower disease Y |
| **Population Fallacy** | Evidence in one population generalized | Pediatric study marketed to adults |
| **Mechanism ≠ Outcome** | Pathway demonstrated but outcome not proven | In vitro antioxidant used to claim prevention |
| **Publication Bias** | Only positives published | Industry-funded: 12 positive, 0 negative |
| **Surrogate Endpoint** | Intermediate marker for actual outcome | LDL reduction = heart attack prevention |
| **Misattribution** | Benefit from A credited to B | Ghee breed benefits credited to A2 protein |
| **Absence of Evidence** | No peer-reviewed studies support | Zero RCTs for marketed outcome |
| **Replication Failure** | Original not reproduced independently | P-hacked pilot never replicated |
...
- In vitro, animal models may *explain* but cannot *establish*.
...
If true: replicable RCTs, dose-response, mechanistic + clinical data, independent confirmation, regulatory evaluation. Absence of all = high-confidence falsification.

---

## SOURCE CREDIBILITY SCORE + APPLICABILITY SCORE **[CORE]**

**Separation rule:** Report both independently.
...
**Weighting:** For RCTs, multiply Funding Independence by **1.5×**.
...
**Total: 0–3.** Score 0 → evidence cannot support claim regardless of Credibility.

**Combined:** High Credibility (7–9) + Low Applicability (0–1) = misattribution. Low Credibility (0–3) + High Applicability (2–3) = relevant but unreliable. High + High = strong.
...
|---|---|---|---|
| **High** | Consistent high-quality RCTs/reviews | Bias, inconsistency, indirectness, imprecision, pub bias | — |
| **Moderate** | One high-quality RCT or consistent moderate | Any serious limitation | Large effect, dose-response, confounders reduce |
...
Upgrade: Large effect, Dose-response, Confounders reduce.
...
|---|---|---|
| 1 | **Applicability** | A highly applicable study outweighs a less applicable one, even if the latter has higher journal prestige |
...
**Rule:** Document every arbitration decision explicitly: "Study A (Applicability 3, GRADE Moderate, Independence Strong, Credibility 8) is preferred over Study B (Applicability 1, GRADE High, Independence Weak, Credibility 9) because Applicability and Independence outweigh Credibility and GRADE."
...
**Rule:** Apply modifier after all other assessments. Only override if evidence is exceptionally strong and independently replicated across multiple labs. State: "Confidence reduced by one level due to historically low replication rates in [domain]."
...
**Core rule:** Weak evidence cannot strongly update an extraordinary prior. Strong evidence can overturn a prior only when independently replicated.
...
|---|---|---|
| **0** | Exact match | "Ghee contains butyric acid" |
| **1** | Minor simplification | "Ghee supports gut health" |
| **2** | Moderate extrapolation | "A2 milk is easier to digest" |
| **3** | Significant generalization | "A2 ghee is healthier" |
| **4** | Unsupported extension | "A2 ghee improves heart health" |
| **5** | Evidence absent | "A2 ghee cures diabetes" |

**Rule:** Every claim must include a Leap Index (0–5). Claims ≥3 require leap explanation. Claims ≥4 trigger heightened skepticism.

---

## CLAIM STATUS TAXONOMY **[CORE]**
...
**Rule:** When stating a verdict, always classify it in the taxonomy. "This claim is classified as [Status]."
...
> **How to use:** Each section has an Activation Trigger. Include only if met. Skip entirely in CORE mode.
...
|---|---|---|---|
| **Health / Nutrition** | PubMed, Cochrane | Embase, PsycINFO | FDA FAERS, WHO, EFSA |
...
## ADVANCED: PREPRINT & REGISTRY PROTOCOL **[MANDATORY]**
...
5. medRxiv/bioRxiv: treat as conference abstract — promising, not proven.
6. SSRN finance: check for subsequent journal publication.

---

## ADVANCED: AMSTAR-2 AND ROBIS **[MANDATORY]**
...
## ADVANCED: COST-BENEFIT VERDICT **[MANDATORY]**

**Trigger:** Product carries a price premium vs. cheaper alternatives.

Quantify: price gap, cost per mg/bioactive, worth-it threshold analysis, adversarial economics, marketed premium analysis.
...
| Career / tenure incentives | Present / Absent |
| Activist / advocacy incentives | Present / Absent |
| Regulatory / legal incentives | Present / Absent |
...
- [ ] Domain Reproducibility Modifier applied (if applicable)
- [ ] Evidence Arbitration Rule documented (if conflicts)
...
- [ ] Actionability Assessment (True vs Meaningful vs Actionable)
- [ ] Consistency audit
- [ ] Cost-benefit check
- [ ] AI disclosure check
...
| 10 | Actionability Assessment | Three separate verdicts (True, Meaningful, Actionable) |
...
|---|---|---|
| 5.2 | 2026-06-07 | Added: Mode Selection (CORE vs FULL AUDIT), Evidence Arbitration Rule, Domain Reproducibility Modifier, Unknown Unknowns Check, Actionability Assessment (True vs Meaningful vs Actionable). All five additions are surgical and focused on specific failure modes — no new scoring systems, hierarchies, or regulatory modules added. |
| 5.1 | 2026-06-07 | Calibration Audit, Evidence Independence Audit, PRISMA Anti-Fabrication, Confidence Ceiling, Claim Status Taxonomy, Missing Evidence Audit, Researcher Incentive Audit, Negative Evidence Search, Verdict Stability Test, Epistemic Humility. |
| 5.0 | 2026-06-07 | Split Source Score → Credibility + Applicability. Posterior Confidence, Evidence Decay, Counterfactual Challenge, Red Team Phase, Uncertainty Budget, Final Epistemic Verdict. |
...
| 3.1 | 2026-06-07 | PRISMA matrix, preprint protocol, GRADE, AMSTAR-2/ROBIS, audience calibration, legal escalation, AI disclosure, hard word count maxima, Phase 1 gates, 36 gates, three-file integrity, changelog. |
...
*Article Prompt v5.2. Production-ready. Surgical additions only.*
